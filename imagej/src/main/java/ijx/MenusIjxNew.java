...
@see ImageJ
 */
public class MenusIjxNew implements IjxMenus {
    ...
    public MenusIjxNew(IjxTopComponent tc, IjxApplication _ijApp, Applet appletInstance) {
        topComponent = tc;
        ijApp = _ijApp;
...
// From plugins.config => Plugins>Jif, "ToolBarTest", edu.mbl.jif.ijplugins.ToolBarTest("")
...
//    mbar.setHelpMenu(help);
    ...
    public static void updateImageJMenus() {
        ...
        menusTable = null;
        MenusIjxNew m = new MenusIjxNew(IJ.getTopComponent(), IJ.getInstance(), IJ.getApplet());
        String err = m.buildMenus();
